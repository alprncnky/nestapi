...
export const CreateReliabilityTrackingMapping = {
  ...
  predictedImpact: () =>
    EnumField(
      ...
      'Predicted impact',
      PredictionImpactEnum.UP,
      false,
    ),
  predictedChangePercent: () =>
    NumberField('Predicted change percentage', 2.5, false, -100, 100),
  predictionConfidence: () =>
    NumberField('Prediction confidence (0-100)', 85.5, false, 0, 100),
  timeWindow: () =>
    StringField('Time window (e.g., 1H, 4H, 1D)', '1D', false, 2, 10),
};
...
export const UpdateReliabilityTrackingMapping = {
  ...
  actualChangePercent: () =>
    NumberField('Actual change percentage', 3.2, false, -100, 100),
  predictionAccuracy: () =>
    NumberField('Prediction accuracy (0-100)', 92.5, false, 0, 100),
  evaluationDate: () =>
    StringField('Evaluation date', '2024-01-02T00:00:00Z', false),
};

export const SaveReliabilityTrackingMapping = {
  id: () =>
    NumberField('Reliability tracking ID (optional, for updates)', 1, false),
  articleId: () =>
    NumberField('Article ID', 1, true, 1),
  stockSymbol: () =>
    StringField('Stock symbol', 'AAPL', true, 1, 10),
