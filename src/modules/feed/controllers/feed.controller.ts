...
export class FeedController extends BaseController<Feed, SaveFeedDto, SaveFeedDto, FeedResponseDto, FeedListResponseDto> {
  constructor(private readonly feedService: FeedService, private readonly feedRepository: FeedRepository) {
    super({service: feedService, repository: feedRepository, responseClass: FeedResponseDto, listResponseClass: FeedListResponseDto, entityName: 'Feed', requestClass: SaveFeedDto});
  }
